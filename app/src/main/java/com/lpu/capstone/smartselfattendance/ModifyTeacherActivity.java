...
public class ModifyTeacherActivity extends AppCompatActivity {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                { User user = snapshot.getValue(User.class);
                    assert user!=null;
                    if(user.getId().equals(givenId) && user.getLevel().equals("2"))
                    {
                        tfUID = user.getfID();
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(user!=null)
                    {
                        ...
                        if(ProjectUtils.setSubjectList().contains(user.getSubject()))subject.setSelection(ProjectUtils.setSubjectList().indexOf(user.getSubject()));
    ...
    private void updateTeacherInDatabase() {
        ...
        ProgressDialog dialog = new ProgressDialog(ModifyTeacherActivity.this);
        dialog.setMessage("Saving");
        dialog.show();
        HashMap<String, Object> map = new HashMap<>();
        map.put("name",name.getText().toString().trim());
        map.put("gender",gender.getSelectedItem().toString().trim());
        map.put("subject",subject.getSelectedItem().toString().trim());
