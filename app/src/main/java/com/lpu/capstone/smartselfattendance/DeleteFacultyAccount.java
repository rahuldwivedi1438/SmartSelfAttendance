...
public class DeleteFacultyAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_faculty_account);
        ...
        getSupportActionBar().setTitle("Delete Faculty's Account");
        ...
        dialog = new ProgressDialog(DeleteFacultyAccount.this);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    assert user != null;
                    if (user.getId().equals(id.getText().toString()) && user.getLevel().equals("2")) {
                        tfUID = user.getfID();
                        facultyPassword = user.getPassword();
    ...
    private void deleteAccount() {
        ...
        signInwithFacultyAccount();
    }

    private void signInwithFacultyAccount() {
        FirebaseAuth.getInstance().signInWithEmailAndPassword(facultyEmail, facultyPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            @Override
    ...
    private boolean Valid() {
        ...
        if (id.getText().toString().length()!= 6) {
            valid = false;
            id.setError("6 Characters Needed");
        }
